                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    {{-- <a class="dropdown-item modalLink" data-modal-size="modal-lg" title="@lang('parentregistration::parentRegistration.assign_section')" href="{{url('parentregistration/assign-section', [$student->id])}}"  data-id="{{$student->id}}"  >@lang('parentregistration::parentRegistration.assign_section')</a> --}}
