...
<head>
    ...
    @if(userRtlLtl() ==1)
        <style>
            ...
            html[dir="rtl"] .primary-input:focus ~ label, .primary-input.read-only-input ~ label, html[dir="rtl"] .has-content.primary-input ~ label {
                text-align: right !important;
            }

            html[dir="rtl"] .primary-input ~ label {
                left: auto;
                right: 0 !important;
                text-align: right;
            }
                ...
                <div class="col-lg-12">
                    <div class="text-center white-box single_registration_area">
                        ...
                        @if($reg_setting->registration_permission == 1)
                            <form method="POST" class="" action="{{route('parentregistration-student-store')}}"
                                ...
                                <div class="row">
                                    ...
                                    @if(in_array('session',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect" id="academic-year-div">
                                                <select class="niceSelect w-100 bb form-control" name="academic_year"
                                    ...
                                    @if(in_array('class',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect" id="class-div">
                                                <select class="niceSelect w-100 bb form-control" name="class"
                                                        id="select-class">
                                    ...
                                    @if(in_array('section',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect" id="section-div">
                                                <select class="niceSelect w-100 bb form-control" name="section"
                                                        id="select-section">
                                    ...
                                    @if(in_array('date_of_birth',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                                        <input class="primary-input mydob date form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}"
                                                               id="startDate" type="text"
                                                               name="date_of_birth" value="{{date('d/m/Y')}}"
                                                               autocomplete="off" id="date_of_birth">
                                                        <label>{{ field_label($fields,'date_of_birth') }} *</label>
                                    ...
                                    @if(in_array('blood_group',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control" name="blood_group">
                                                    <option data-display="{{ field_label($fields,'blood_group') }}"
                                                            value=""> {{ field_label($fields,'blood_group') }} </option>
                                                    @foreach($blood_groups as $group)
                                                        <option value="{{$group->id}}" {{old('blood_group') == $group->id? 'selected': ''}}>{{$group->base_setup_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @if($errors->has('blood_group'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('blood_group') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                    ...
                                    @if(in_array('religion',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control" name="religion">
                                            ...
                                            @if($errors->has('religion'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('religion') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                    ...
                                    @if(in_array('email_address',$active_fields))
                                        <div class="col-lg-6">
                                            ...
                                            @if($errors->has('student_email'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('student_email') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group input-group">
                                                <input class="form-control" type="text" name='phone_number'
                                                       id="phone_number"
                                                       placeholder="{{ field_label($fields, 'phone_number') }} {{moduleStatusCheck('Lead') == true ? '*' : ''}}"
                                    ...
                                    @if(in_array('lead_city',$active_fields) && moduleStatusCheck('Lead')==true)
                                        <div class="col-lg-6">
                                            ...
                                            @if($errors->has('lead_city'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('lead_city') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                    @if(in_array('source_id',$active_fields) && moduleStatusCheck('Lead')==true)
                                        <div class="col-lg-6">
                                            ...
                                            @if($errors->has('source_id'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('source_id') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control"
                                                    ...
                                                    <option data-display="{{ field_label($fields,'student_category_id') }}"
                                                            value="">{{ field_label($fields,'student_category_id') }}</option>
                                            ...
                                            @if($errors->has('student_category_id'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('student_category_id') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                    @if(in_array('student_group_id',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control"
                                                    ...
                                                    <option data-display="{{ field_label($fields,'student_group_id') }}"
                                                            value="">{{ field_label($fields,'student_group_id') }}</option>
                                            ...
                                            @if($errors->has('group'))
                                                <div class="text-danger error-message invalid-select mb-10">{{ $errors->first('group') }}</div>
                                            @endif
                                        </div>
                                    @endif
                                            ...
                                            <div class="d-flex radio-btn-flex ml-30">
                                                <div class="mr-20">
                                                    <input type="radio" name="relationButton" id="relationFather"
                                                           value="F"
                                                           class="common-radio relationButton" {{old('relationButton', 'F') == "F"? 'checked': ''}}>
                                                ...
                                                <div>
                                                    <input type="radio" name="relationButton" id="relationOther"
                                                           value="O"
                                                           class="common-radio relationButton" {{old('relationButton') == "O" ? 'checked': ''}}>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            @if($errors->has('guardian_email'))
                                                <div class="text-danger error-message invalid-select mb-10"
                                                     id="guardian_email_error">{{ $errors->first('guardian_email') }}</div>
                                            @endif
                                    ...
                                    @if(in_array('guardians_phone',$active_fields))
                                        <div class="col-lg-6">
                                            ...
                                            @if($errors->has('guardian_mobile'))
                                                <div class="text-danger error-message invalid-select mb-10"
                                                     id="guardian_mobile_error">{{ $errors->first('guardian_mobile') }}</div>
                                            @else
                                                <div class="text-danger error-message invalid-select mb-10"
                                    ...
                                    @if(in_array('route',$active_fields))
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control" name="route"
                                                        id="route">
                                            ...
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('dormitory_name') ? ' is-invalid' : '' }}"
                                                    ...
                                                    <option data-display=" {{ field_label($fields,'dormitory_name') }} "
                                                            value="">{{ field_label($fields,'dormitory_name') }}</option>
