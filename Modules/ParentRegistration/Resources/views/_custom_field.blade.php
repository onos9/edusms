            ...
            @elseif($custom_field->type=="multilineInput")
                ...
                <div class="{{$custom_field->width}}">
                    <div class="form-group input-group">
                        ...
                        <textarea class="primary-input form-control" placeholder="{{$custom_field->label}}" cols="0" rows="3" name="customF[{{$custom_field->label}}]">{{(isset($student)) ?customFieldValue($student->id,$custom_field->label,$student->custom_field_form_name):""}}</textarea>
                    ...
                    <div class="no-gutters input-right-icon">
                        <div class="col">
                            <div class="input-effect sm2_mb_20 md_mb_20">
                                <input class="primary-input date form-control{{ $errors->has($custom_field->label) ? ' is-invalid' : '' }}" placeholder="{{$custom_field->label}}" id="startDate" type="text"
