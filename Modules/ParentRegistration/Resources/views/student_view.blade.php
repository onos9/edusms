...
@php  $setting = App\SmGeneralSettings::where('school_id', Auth::user()->school_id)->first();  if(!empty($setting->currency_symbol)){ $currency = $setting->currency_symbol; }else{ $currency = '$'; }   @endphp 
    ...
    <section class="student-details">
        <div class="container-fluid p-0">
                    ...
                    <div class="tab-content">
                            ...
                            @endif
                                ...
                                <div class="d-flex">
                                    <div class="mr-20 mt-20">
                                            <img class="student-meta-img img-100" src="{{ file_exists(@$student_detail->fathers_photo) ? asset($student_detail->fathers_photo) : asset('public/uploads/staff/demo/father.png') }}" alt="">
                                ...
                                <div class="d-flex">
                                    <div class="mr-20 mt-20">
                                             <img class="student-meta-img img-100" src="{{ file_exists(@$student_detail->mothers_photo) ? asset($student_detail->mothers_photo) : asset('public/uploads/staff/demo/mother.jpg')}}" alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class="single-info">
                                            <div class="row">
                                ...
                                <div class="d-flex">
                                    <div class="mr-20 mt-20">
                                        <img class="student-meta-img img-100" src="{{ file_exists(@$student_detail->guardians_photo) ? asset($student_detail->guardians_photo) : asset('public/uploads/staff/demo/guardian.jpg')}}" alt="">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            ...
                                            @if($student_detail->document_file_1) <a href="{{ asset($student_detail->document_file_1) }}" download="" >
                                            <i class="fa fa-download mr-1"></i> Download</a> @else No File  @endif 
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            ...
                                            @if($student_detail->document_file_2) <a href="{{ asset($student_detail->document_file_2) }}" download="" >
                                            <i class="fa fa-download mr-1"></i> Download</a> @else No File  @endif 
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            ...
                                            @if($student_detail->document_file_3) <a href="{{ asset($student_detail->document_file_3) }}" download="" >
                                            <i class="fa fa-download mr-1"></i> Download</a> @else No File  @endif 
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            ...
                                            @if($student_detail->document_file_4) <a href="{{ asset($student_detail->document_file_4) }}" download="" >
                                            <i class="fa fa-download mr-1"></i> Download</a> @else No File  @endif 
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12 pull-right">
                                ...
                                <a class="primary-btn fix-gr-bg" href="{{url('parentregistration/student-approve', [$student_detail->id])}}" target="_blank"  data-id="{{$student_detail->id}}"  >@lang('common.approve')</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade admin-query" id="aprroveModal" >
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">@lang('student.student_approve')</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center">
                                <h4>@lang('student.are_you_sure_to_approve')</h4>
                            </div>
            
                            <div class="mt-40 d-flex justify-content-between">
                                <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('common.cancel')</button>
                                 {{ Form::open(['url' => 'parentregistration/student-approve', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                            <input type="hidden" name="id" value="{{@$student_detail->id}}" >  {{-- using js in main.js --}}
                              
                            <button class="primary-btn fix-gr-bg" type="submit">@lang('student.approve')</button>
                                 {{ Form::close() }}
                            </div>
